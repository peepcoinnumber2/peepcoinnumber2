...
public:
    ...
    bool WriteZPP2Seed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZPP2Seed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZPP2Seed_deprecated(uint256& seed);
    bool EraseZPP2Seed();
    bool EraseZPP2Seed_deprecated();

    bool WriteZPP2Count(const uint32_t& nCount);
    bool ReadZPP2Count(uint32_t& nCount);
