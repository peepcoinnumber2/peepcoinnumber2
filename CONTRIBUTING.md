Contributing to PeepCoin Core
============================

The PeepCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PeepCoin Core project, and is not to be
confused with overall PeepCoin Network Protocol consensus changes.

Whether a pull request is merged into PeepCoin Core rests with the project merge
...
Patches that change PeepCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PeepCoin consensus, it must have been
...
The project leader is the release manager for each PeepCoin Core release.
