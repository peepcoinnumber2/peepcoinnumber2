...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PeepCoin features */
        {"peepcoin", "masternode", &masternode, true, true, false},
        {"peepcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"peepcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peepcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peepcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"peepcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"peepcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"peepcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peepcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"peepcoin", "startmasternode", &startmasternode, true, true, false},
        {"peepcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peepcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peepcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peepcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peepcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peepcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peepcoin", "mnbudget", &mnbudget, true, true, false},
        {"peepcoin", "preparebudget", &preparebudget, true, true, false},
        {"peepcoin", "submitbudget", &submitbudget, true, true, false},
        {"peepcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peepcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peepcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peepcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peepcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peepcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peepcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peepcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"peepcoin", "mnsync", &mnsync, true, true, false},
        {"peepcoin", "spork", &spork, true, true, false},
        {"peepcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> peepcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7341/\n";
}
