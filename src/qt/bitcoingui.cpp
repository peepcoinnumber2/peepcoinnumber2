                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PeepCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PeepCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peepcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PeepCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PeepCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PeepCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PeepCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PeepCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a PeepCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PeepCoin Core help message to get a list with possible PeepCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PeepCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("PeepCoin Core"); // default title
