...
#   c) node1 mines 32 blocks, so now node 0 has 60001pp2, node 1 has 4250pp2, node2 has none.
#   d) node0 sends 601 pp2 to node2, in two transactions (301 pp2, then 300 pp2).
