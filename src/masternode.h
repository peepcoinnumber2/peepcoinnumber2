...
#define MASTERNODE_MIN_CONFIRMATIONS 2
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 PP2, signature to prove
