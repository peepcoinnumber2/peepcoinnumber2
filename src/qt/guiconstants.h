...
/* PeepCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PeepCoin"
#define QAPP_ORG_DOMAIN "peepcoin.org"
#define QAPP_APP_NAME_DEFAULT "PeepCoin-Qt"
#define QAPP_APP_NAME_TESTNET "PeepCoin-Qt-testnet"
