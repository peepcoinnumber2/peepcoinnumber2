...
This mechanism has been integrated into Bitcore-Node-PeepCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PeepCoin-Project/insight-api-peepcoin#web-socket-api](https://github.com/PeepCoin-Project/insight-api-peepcoin#web-socket-api) 
* API: [https://github.com/PeepCoin-Project/insight-api-peepcoin#swifttx-transactions](https://github.com/PeepCoin-Project/insight-api-peepcoin#swifttx-transactions) 
...
By default, the PeepCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PeepCoin Core daemon:
