...
In order to support loading of multiple wallets in peepcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peepcoin.cpp.
...
Changes to peepcoin.cpp
----------------------
peepcoin.cpp is the entry point into peepcoin-qt, and as such, will require some minor modifications to provide hooks for
