...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PeepCoin Core peepcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  peepcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded peepcoin transaction") + "\n" +
                               "  peepcoin-tx [options] -create [commands]   " + _("Create hex-encoded peepcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded peepcoin transaction
