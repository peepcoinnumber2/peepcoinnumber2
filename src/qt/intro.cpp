...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PeepCoin Core"),
     ...
     * override -datadir in the peepcoin.conf file in the default data directory
     * (to be consistent with peepcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
