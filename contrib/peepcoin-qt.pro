...
RESOURCES += src/qt/peepcoin.qrc src/qt/peepcoin_locale.qrc

TRANSLATIONS += src/qt/locale/peepcoin_bg.ts \
                src/qt/locale/peepcoin_de.ts \
                src/qt/locale/peepcoin_en.ts \
                src/qt/locale/peepcoin_es.ts \
                src/qt/locale/peepcoin_fi.ts \
                src/qt/locale/peepcoin_fr.ts \
                src/qt/locale/peepcoin_it.ts \
                src/qt/locale/peepcoin_ja.ts \
                src/qt/locale/peepcoin_pl.ts \
                src/qt/locale/peepcoin_pt.ts \
                src/qt/locale/peepcoin_ru.ts \
                src/qt/locale/peepcoin_sk.ts \
                src/qt/locale/peepcoin_sv.ts \
                src/qt/locale/peepcoin_vi.ts \
                src/qt/locale/peepcoin_zh_CN.ts \
                src/qt/locale/peepcoin_zh_TW.ts
